...
var getDtsContent = function (sassInclude, path) { return __awaiter(_this, void 0, void 0, function () {
...
//   ).replace(/\+/,'/')
// }
var writeDtsContent = function (file, content) { return __awaiter(_this, void 0, void 0, function () {
    var _, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var addOrUpdateAction = function (sassInclude, file) { return __awaiter(_this, void 0, void 0, function () {
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = pipeline_1.default;
                return [4 /*yield*/, getDtsContent(sassInclude, file)];
            case 1:
                _b = [_c.sent()];
...
var deleteAction = function (file) { return __awaiter(_this, void 0, void 0, function () {
    var message, e_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
exports.outputDtsFiles = function (_a) {
    // log({watchPattern})
    var _b = _a.watchPattern, watchPattern = _b === void 0 ? '*.module.scss' : _b, _c = _a.sassInclude, sassInclude = _c === void 0 ? ['src/'] : _c;
    var watcher = chokidar.watch(watchPattern, { depth: 10 });
    watcher
        .on('add', bindStrict_1.default(addOrUpdateAction, sassInclude))
        .on('change', bindStrict_1.default(addOrUpdateAction, sassInclude))
